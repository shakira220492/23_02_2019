    ...
    public function getVideosToDeleteAction(Request $request)
    {
        ...
        if ($request->isXMLHttpRequest()) {
            ...
            $videosToDelete = $em->createQuery(
                "SELECT DISTINCT v.videoId, v.videoName, v.videoAmountViews, dvr.deletevideorequestDatetodelete 
                FROM HomeBundle:Video v 
            ...
            while (isset($videosToDelete_v[$i]['videoId'])) {
                if ($videosToDelete_v) {                    
                    $datetodelete_Value = $videosToDelete_v[$i]['deletevideorequestDatetodelete'];
                    $videoId_Value = $videosToDelete_v[$i]['videoId'];
                    $videoName_Value = $videosToDelete_v[$i]['videoName'];
                    $videoAmountViews_Value = $videosToDelete_v[$i]['videoAmountViews'];
                    
                    $datetodelete_String = $datetodelete_Value->format('d-M-Y');
                    
                }
                else {
                    $datetodelete_String = "_";
                    $videoId_Value = "_";
                    $videoName_Value = "_";
                ...
                $users2[$i] = array(
                    'deletevideorequestDatetodelete' => $datetodelete_String,
            ...
            if ($i === 0) {
                $users2[0] = array(
                    'deletevideorequestDatetodelete' => "_",
                    'videoId' => "_",
                    'videoName' => "_",
                    'videoAmountViews' => "_",
                    'amountVideos' => $amountVideos
